...
namespace Travel.API.Migrations
{
    ...
    [Migration("20190214193350_ChangeChargeEnityToCollection")]
    partial class ChangeChargeEnityToCollection
    {
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.CollectionAggregate.Collection", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 14, 20, 33, 49, 972, DateTimeKind.Local).AddTicks(8081));
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.RefuelAggregate.Refuel", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 14, 20, 33, 49, 978, DateTimeKind.Local).AddTicks(2094));
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.TravelAggregate.Trip", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 14, 20, 33, 49, 839, DateTimeKind.Local).AddTicks(9352));
