...
namespace Travel.API.Migrations
{
    ...
    [Migration("20190204174315_Initial")]
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.ChargeAggregate.Charge", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 4, 18, 43, 14, 717, DateTimeKind.Local).AddTicks(8550));
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.RefuelAggregate.Refuel", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 4, 18, 43, 14, 724, DateTimeKind.Local).AddTicks(498));
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.TravelAggregate.Trip", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 4, 18, 43, 14, 694, DateTimeKind.Local).AddTicks(4409));
