...
namespace Travel.API.Migrations
{
    ...
    [Migration("20190221190701_NewColumn_Traveler.LeavingDate")]
    partial class NewColumn_TravelerLeavingDate
    {
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.CollectionAggregate.Collection", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 21, 20, 7, 1, 30, DateTimeKind.Local).AddTicks(1791));
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.RefuelAggregate.Refuel", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 21, 20, 7, 1, 36, DateTimeKind.Local).AddTicks(3382));
            ...
            modelBuilder.Entity("Travel.Domain.AggregatesModel.TripAggregate.Trip", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 2, 21, 20, 7, 0, 989, DateTimeKind.Local).AddTicks(1956));
